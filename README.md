...
height:50px;
border-radius:50%;
background:linear-gradient(135deg, rgba(0,119,181,0.4), rgba(0,119,181,0.2));
margin:18px auto 0;
display:flex;
align-items:center;
...
<div style="color:#00A0DC; font-size:14px; font-weight:700; margin-top:14px; text-shadow: 0 0 10px rgba(0,160,220,0.5); letter-spacing: 0.5px;">
LinkedIn
</div>
...
height:130px;
border-radius:20px;
background:linear-gradient(145deg, rgba(29,161,242,0.3) 0%, rgba(29,161,242,0.08) 100%);
border:1px solid rgba(29,161,242,0.4);
display:inline-block;
text-align:center;
vertical-align:middle;
box-shadow:0 10px 30px rgba(29,161,242,0.2), inset 0 1px 1px rgba(255,255,255,0.1);
backdrop-filter: blur(10px);
transition: all 0.3s ease;
">
<div style="
...
<div style="color:#1DA1F2; font-size:14px; font-weight:700; margin-top:14px; text-shadow: 0 0 10px rgba(29,161,242,0.5); letter-spacing: 0.5px;">
Twitter/X
</div>
<div style="color:#7BC0F0; font-size:10px; margin-top:4px; font-weight:400; opacity:0.8;">
Follow
</div>
</div>
</a>
...
justify-content:center;
font-size:26px;
box-shadow: 0 4px 15px rgba(110,84,148,0.3);
">
🐙
</div>
<div style="color:#B8A9D4; font-size:14px; font-weight:700; margin-top:14px; text-shadow: 0 0 10px rgba(184,169,212,0.5); letter-spacing: 0.5px;">
GitHub
</div>
...
<div style="color:#FF6B6B; font-size:14px; font-weight:700; margin-top:14px; text-shadow: 0 0 10px rgba(255,107,107,0.5); letter-spacing: 0.5px;">
Email
</div>
...
<div style="color:#FFB74D; font-size:14px; font-weight:700; margin-top:14px; text-shadow: 0 0 10px rgba(255,183,77,0.5); letter-spacing: 0.5px;">
Portfolio
</div>
